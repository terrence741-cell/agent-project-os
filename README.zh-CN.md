...
当前分支是 V1.0.1 发布候选。仓库已同时提供两种宿主的 Marketplace 清单，但最终公开 GitHub 安装命令要等第 4 阶段用真实仓库 URL 在全新 Codex 和 Claude Code 环境中验证后才发布。在此之前，请通过宿主的本地 Marketplace／插件源流程添加本仓库，并且只选择一个语言包。
