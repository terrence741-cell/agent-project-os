...
description: "Compare multiple non-code Markdown projects to surface blockers, staleness, conflicts, or duplication across client delivery, content operations, research, or long-term personal work. Use only when the user clearly asks about several projects or a portfolio, such as “what projects do I have?”, “which of these should I do first?”, “which one is urgent?”, “are these duplicated?”, “review the whole portfolio”, or “do my projects conflict?”. Read a thin index or bounded set of entries, not project bodies. Surface evidence such as blockers, waits, and dates while leaving ranking to the user and status to each project source. Not for “what should I do next?” or daily planning inside one named project."
---
